...
public class CQ_1117_TxtCtrl_Utilisation_de_l_éditeur_de_texte_depuis_la_Prescription_Medicamenteuse extends BaseTest{
	...
	@Test
	@Xray(test="CQ-1117")
	public void  CQ_1117_Utilisation_de_l_éditeur_de_texte_depuis_la_Prescription_Medicamenteuse() throws InterruptedException, IOException {
		...
		pageTraitements.gerer_Donnees_Affichees_sur_l_ordonnance("Arial", "8");
		...
		textEditorPage.saisie_des_informations_dans_le_textediteur("CQ-1117");
		...
		ordonnancePDF.verifierPoliceFont();
...
//		textEditorPage.switchTowindow(0);
		...
		textEditorPage.valider_et_ouvrir_le_document();
		ordonnancePDF.readpdfItext("HAVLANE");
		ordonnancePDF.readpdfItext("Prescriptions relatives au traitement de l´affection de longue durée reconnue (AFFECTION EXONERANTE)");
		ordonnancePDF.readpdfItext("Prescriptions SANS RAPPORT avec l´affection de longue durée (MALADIES INTERCURRENTES)");
		ordonnancePDF.readpdfItext("LODOZ");
		ordonnancePDF.switchTowindow(0);
		//pageDossierMedical.prescrireMedicaments();
		pageTraitements.commencerNouveauTraitement();
        moduleAjoutProduits = new ModuleAjoutProduits();
		...
		textEditorPage.valider_et_ouvrir_le_document();
		ordonnancePDF.readpdfItext("EFFERALGAN");
		ordonnancePDF.readpdfItext("Ne pas délivrer");
		textEditorPage.switchTowindow(0);
